...
function confPrompt( des, print)
{
  var des = prompt (print);
  des = parseInt(des);
  return des;
}
...
function cambiarLimiteDeExtraccion()
{
  ...
  limiteExtraccion = confPrompt (limiteExtraccion , "¿Cual quiere que sea su limite de extraccion?");
...
{
  var extraccion = confPrompt( extraccion, "¿Cuanto dinero quiere extraer?:");
...
{
  var deposito = confPrompt( deposito, "¿Cuanto dinero quiere depositar?");
...
function pagarServicio()
{
  ...
  var servicio = confPrompt(servicio, "Ingrese el numero que corresponda con el servicio que quieres pagar: \n 1- Agua \n 2- Telefono \n 3- Luz \n 4- Internet");
...
function transferirDinero()
{
     ...
     var transferencia = confPrompt(transferencia, "¿Cuanto dinero desea transferir?");
     ...
     else
     {
                 ...
                 {
                         var cuenta = confPrompt(cuenta, "Ingrese el numero de cuenta amiga a la que desea transferir el dinero");
...
function iniciarSesion()
{
  ...
  var confCodigo = confPrompt( confCodigo, "Ingrese su codigo:");
